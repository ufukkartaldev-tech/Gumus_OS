...
// Sistem Monitörü Pencere Verisi
typedef struct {
    cpu_stats_t cpu;
    ram_stats_t ram;
    ...
    int update_counter;
    int refresh_rate; // Her kaç tick'te bir güncellenecek
